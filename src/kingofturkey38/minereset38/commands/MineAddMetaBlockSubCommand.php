...
class MineAddMetaBlockSubCommand extends BaseSubCommand{
	protected function prepare() : void{
		$this->registerArgument(0, new RawStringArgument("name"));
		$this->registerArgument(1, new IntegerArgument("blockID"));
        $this->registerArgument(2, new IntegerArgument("blockMeta"));
		$this->registerArgument(3, new IntegerArgument("chance"));
	}
